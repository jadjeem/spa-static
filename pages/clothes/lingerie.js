...
import { getLingerires } from '../api/api';
    ...
    <Layout global={global} pageContext={pageContext} sider={sider}>
      ...
      {/* Content */}
      {
        loading ? (
          ...
          <ProductsView products={data} totalCount={meta?.pagination.total} pageSize={meta?.pagination.pageSize} page={page} setPage={setPage} />
        )
      }
    </Layout>
  );
